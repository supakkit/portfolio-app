  ...
  workExperience: [
    {
      ...
      organization: "Professional Service United",
      startDate: "2022-10",
      lastDate: "2024-03",
      details: [
        "Collaborated with the engineering team to deliver customized machines to clients.",
        "Worked closely with technicians to manufacture machine parts based on the designs.",
        "Prioritized tasks effectively to meet project deadlines.",
        "Analyzed mechanical issues and developed practical solutions.",
      ],
    },
    {
      ...
      lastDate: "2022-02",
      details: [
        "Coordinated between researchers and technicians to ensure project goals were met.",
        "Designed and tested prototypes to develop effective solutions for research problems.",
        "Assisted researchers and staff in executing project tasks.",
      ],
    },
  ],
  education: [
    {
      role: "Learner | Junior Software Developer Program",
      organization: "Generation Thailand",
      startDate: "2025-05",
      lastDate: "2025-09",
      details: [
        "Completed a full-stack developer bootcamp mastering core industry technologies.",
        "Collaborated in an agile team environment to develop an E-commerce web application.",
        "Independently applied learned knowledge to create and deploy personal projects.",
      ],
    },
    {
      role: "Bachelor of Engineering in Mechanical Engineering",
      organization: "Chiang Mai University, Chiang Mai",
      startDate: "2015-08",
      lastDate: "2019-05",
      details: [],
    },
